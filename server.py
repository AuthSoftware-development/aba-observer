...
@app.get("/api/retail/stores/{store_id}")
...
@app.get("/api/aba/report/{filename}")
...
@app.delete("/api/security/alerts/{rule_id}")
...
@app.get("/api/security/alerts/history")
...
@app.post("/api/access-control/webhook")
...
@app.get("/api/access-control/events")
...
@app.get("/api/access-control/tailgating")
...
@app.get("/api/search/face/{consent_id}")
